...
from pyspark.sql.functions import ceil, col, to_date, udf, when
...
df_start = spark.sql(
    ...
    WHERE
        ...
        AND gpa.statusrequest NOT IN ('PN999', 'PN998', 'error', 'internalError', 'syntaxError','transformationError','semanticError','authenticationError', 'duplicatedRequest')
"""
)
...
spark.sql("""SELECT * FROM DF_OUTPUT""").writeTo("send_dev.wi7_consolidatore").using(
    "iceberg"
